    ...
    navbarMenu('Transcriptome Analysis',
               ...
               tabPanel(
                 ...
                 sidebarPanel(
                   conditionalPanel(
                     ...
                     downloadButton("downloaddist1", "Download as PNG"),
                   ),
               ...
               tabPanel(
                 ...
                 sidebarPanel(
                   ...
                   downloadButton("noise", "Download as PNG"),
...
server <- function(input, output, session) {
  ...
  output$downloaddist1 <- downloadHandler(
    filename = function() {
      paste("distribution_fit", ".png", sep = "")
    },
    content = function(file) {
      pdf(file)
      distplot()
  ...
  output$noise <- downloadHandler(
    filename = function() {
      paste("./noise", ".png", sep = "")
    },
    content = function(file) {
      htmlwidgets::saveWidget(widget = noisePlot(), file = "badae.html")
      webshot(url = "./badae.html", file = file)
    }
